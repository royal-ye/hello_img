...
function NonparametricPatchAutoencoderFactory.buildAutoencoder(target_img, mask, patch_size, stride, threshold, shuffle, normalize, interpolate)
    ...
    local patches_all, patches_part, centers_lt, centers_rb, flag = NonparametricPatchAutoencoderFactory._extract_patches(target_img, mask, patch_size, stride, threshold, shuffle)
    ...
    return conv_enc_all, conv_enc_nonMask, conv_dec_all, conv_dec_nonMask, centers_lt, centers_rb, flag
end
...
-- transfer table back to tensor
    ...
    return patches_all, patches, centers_lt, centers_rb, flag
end
