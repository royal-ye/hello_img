require 'lib/Nonparametric_especial'
...
function InnerSwap:updateOutput(input)
    ...
    _, self.conv_enc, self.conv_new_dec, _ , self.centers_lt, self.centers_rb, self.flag = NonparametricPatchAutoencoderFactory.buildAutoencoder(
